...
public abstract class Animal {
    ...
    public int randomNumber(int maxNumber, int minNumber) {
        int x = random.nextInt((maxNumber+1)-minNumber) + minNumber;
        return x;
    }
    ...
    protected void fight(int maxNumber, int minNumber){
        System.out.println("the " + this.getClass().getSimpleName() + " is fighting");
        currentCapacity -= randomNumber(maxNumber, minNumber);
        isAlive();
    }
